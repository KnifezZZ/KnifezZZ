<template>
  <div id="yur-footer">
          ...
          <div class="footer-center">
            <h2>
              <a-skeleton active :loading="loading">
                <img :src="require('../media/images/footer-title-icon-1.png')" :alt="title" />
              </a-skeleton>
              <span>推荐资源</span>
            </h2>
            <div v-for="(item, index) in footer[0]" :key="index">
        ...
        <a-col :xs="24" :sm="24" :md="8">
          <div class="footer-center">
            ...
            <template v-if="footer[1].length">
              <div v-for="(item, index) in footer[1]" :key="index">
                <a :href="item.link" target="_blank" rel="noopener noreferrer">
        ...
        <a-col :xs="24" :sm="24" :md="8">
          <div class="footer-center">
            ...
            <template v-if="footer[2].length">
              <div v-for="(item, index) in footer[2]" :key="index">
                <a :href="item.link" target="_blank" rel="noopener noreferrer">
                  <a-icon :type="item.type" :theme="item.theme" />
                  <span>{{ item.title }}</span>
                </a>
    ...
    <div class="bottom-bar">
      Powered by
      <a href="https://vuepress.vuejs.org/zh/" rel="nofollow">VuePress</a>
      &nbsp;|&nbsp;
      <a-icon type="smile" style="color:#faad14" />
